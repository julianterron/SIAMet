                ...
                <div class="card-header">
                    ...
                    @can('Agregar usuarios')
                        <div class="card-tools">
                            <a href="{{ route('user.create') }}" class="btn btn-sm btn-success pull-right"><i class="glyphicon glyphicon-plus"></i> Nuevo</a>
                        </div>
                    @endcan
                </div>
                <div class="card-body">
                    ...
                    @php
                        $heads = ['ID', 'Nombre', 'Usuario', 'Email', ['label' => 'Acciones', 'no-export' => true, 'width' => 15]];
